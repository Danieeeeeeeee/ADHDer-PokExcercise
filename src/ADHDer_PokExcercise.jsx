...
export default function App() {
  ...
  useEffect(() => {
    ...
    s.textContent = [
      ...
      "  #app-outer{max-width:100%!important;padding-left:380px;}",
      "  #app-header{position:fixed;top:0;left:0;width:380px;z-index:100;border-right:1px solid #2a2a2a;box-sizing:border-box;}",
      "  #app-xpbar{position:fixed;top:128px;left:0;width:380px;z-index:100;border-right:1px solid #2a2a2a;border-bottom:none!important;box-sizing:border-box;background:linear-gradient(135deg,#111 0%,#1a1a0a 100%);}",
      "  #app-tabbar{position:fixed;top:180px;left:0;width:380px;height:calc(100vh - 180px);z-index:100;flex-direction:column!important;overflow-x:hidden!important;overflow-y:auto;border-bottom:none!important;border-right:1px solid #2a2a2a;padding:8px 0!important;box-sizing:border-box;background:#111;}",
